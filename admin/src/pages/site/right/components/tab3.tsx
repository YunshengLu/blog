...
import {
    ...
    updateRecommend,
    removeRecommend,
} from '@/api/request/site/right';
import { projects, showPositions, showPositionsColorObj } from '@/utils/utils';
...
function Tab3() {
    ...
    const recommendState = useSelector(
        (state: ReducerState) => state.recommend
    );
                ...
                >
                    <Form {...formItemLayout} form={form}>
                        ...
                        <Form.Item
                            ...
                            field="imgs"
                            rules={[
                                { required: true, message: '请上传封面/链接' },
                            ]}
                        >
                            <UploadImage />
                        </Form.Item>
