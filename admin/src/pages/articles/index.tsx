 ...
 * @LastEditTime: 2022-09-01 22:06:33
 */
...
import {
    ...
    updatePublishStatus,
    updateCollectStatus,
} from '@/api/request/articles';
import { publishStatusOptions, statusOptions } from '@/utils/utils';
import { getList as getTagsList } from '@/api/request/tags';
import { getList as getCategoriesList } from '@/api/request/categories';
...
function Articles() {
    ...
    const columns = [
...

        {
            ...
            render: (_, record) => {
                return dayjs(record.createTime * 1000).format(
                    'YYYY-MM-DD HH:mm:ss'
                );
            },
        },
    ...
    async function fetchData(current = 1, pageSize = 20, params = {}) {
        ...
        try {
            ...
            if (res) {
                ...
                dispatch({ type: ActionTypes.UPDATE_LOADING, data: { loading: false } });
...
//       console.log(res);
//       if (res) {
//         dispatch({ type: ActionTypes.UPDATE_LIST, payload: { data: res.data.list } });
//         dispatch({
//           type: ActionTypes.UPDATE_PAGINATION,
//           payload: { pagination: { ...pagination, current, pageSize, total: res.data.totalCount } },
//         });
//         dispatch({ type: ActionTypes.UPDATE_LOADING, payload: { loading: false } });
//         dispatch({ type: ActionTypes.UPDATE_FORM_PARAMS, payload: { params } });
//       }
//     } catch (error) {}
//   }
