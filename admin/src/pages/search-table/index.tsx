 ...
 * @LastEditTime: 2022-09-01 22:10:52
 */
...
function SearchTable() {
  ...
  function fetchData(current = 1, pageSize = 10, params = {}) {
    ...
    axios
      ...
      .then((res) => {
        dispatch({ type: UPDATE_LIST, data: { data: res.data.list } });
        dispatch({
          type: UPDATE_PAGINATION,
          data: { pagination: { ...pagination, current, pageSize, total: res.data.total } },
        });
        dispatch({ type: UPDATE_LOADING, data: { loading: false } });
        dispatch({ type: UPDATE_FORM_PARAMS, data: { params } });
      });
  }
